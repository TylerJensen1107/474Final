...
//   // Get the data again
//   var updatedData = [[1,130.81], [2,146.83], [3,164.81], [4,174.61], [5,196.00], [6,220.00], [7,246.94], [8,261.63]];

//   // Scale the range of the data again
//     var x = d3.scale.linear()
//               .domain([0, d3.max(updatedData, function(d) { return d[0]; })]);
    
//     var y = d3.scale.linear()
//             .domain([0, d3.max(updatedData, function(d) { return d[1]; })]);
